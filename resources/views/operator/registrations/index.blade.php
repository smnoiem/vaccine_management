                ...
                <table class="table tabe-hover table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><b>{{ ucwords($registration->user->name) }}</b></td>
                            <td><b>{{ ucwords($registration->user->phone) }}</b></td>
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu" style="">
                                    ...
                                    <a class="dropdown-item doses" href="{{ route('operator.registrations.doses', $registration->id) }}" data-id="{{$registration->id}}">Doses</a>
                                </div>
                            </td>
                        </tr>	
                        @endforeach
