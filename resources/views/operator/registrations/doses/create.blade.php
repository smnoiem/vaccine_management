...
<div class="col-lg-12">
        ...
        <div class="card-body">
            <form action="" id="dose_form">
                ...
                <div class="row">
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="phone" value="{{$registration->user->phone}}" readonly>
                            <small id="#msg"></small>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-lg-12 text-right justify-content-center d-flex">
                    ...
                    <button class="btn btn-secondary" type="button" onclick="location.href = '{{route('operator.registrations.doses', $registration->id)}}'">Cancel</button>
                </div>
            </form>
        </div>
    </div>
	...
	<script>
		$('#dose_form').submit(function(e){
			e.preventDefault()
			$.ajax({
				url:'{{route("operator.registrations.doses.store", $registration->id)}}',
				...
				success:function(resp){
					if(resp == 1){
						...
						setTimeout(function(){
							location.replace('{{route('operator.registrations.doses', $registration->id)}}')
						},750)
					}
					else if(resp == 2){
